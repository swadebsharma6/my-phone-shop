...
const Contact = () => {
    return (
        <section className="">
         ...
         <div className="footer footer-center p-10 bg-primary rounded text-primary-content">
  <aside>
    ...
    <p className="font-bold">
      SM-TechBd <br/>Providing reliable tech since 2020
    </p> 
    <p>&copy;swadebsharma2022@gmail.com</p>
  </aside> 
  <nav>
